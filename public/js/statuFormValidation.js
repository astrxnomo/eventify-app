document.getElementById('StatusForm').addEventListener('submit', function(event) {
    ...
    const StatuName = document.getElementById('name').value.trim();
    

    // Validar nombre de la categoria
    if (StatuName.length < 5 || StatuName.length > 100) {
        errors.push("El nombre del estado debe tener entre 5 y 100 caracteres.");
    }
